...
public class AuswahlTest {
    ...
    public void ausgewaehlt () {
        ...
        Assert.assertEquals("not set", Auswahl.ausgewaehlt("xxx", suggestionEuro, "0", "not set", "not set"));
        Assert.assertEquals("not set", Auswahl.ausgewaehlt("xxx", suggestionDol, "0", "not set", "not set"));
        Assert.assertEquals("not set", Auswahl.ausgewaehlt("xxx", suggestionPeso, "1", "not set", "not set"));
        Assert.assertEquals("Australian dollar", Auswahl.ausgewaehlt("1", suggestionDol, "0", "not set", "not set"));
        Assert.assertEquals("Singapore dollar", Auswahl.ausgewaehlt("5", suggestionDol, "0", "not set", "not set"));
        Assert.assertEquals("Chilean peso", Auswahl.ausgewaehlt("0", suggestionPeso, "0", "Euro", "U.S. dollar"));
        Assert.assertEquals("Chilean peso", Auswahl.ausgewaehlt("0", suggestionPeso, "1", "New Zealand dollar", "Trinidadian dollar"));
